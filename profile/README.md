...
- improve what’s (to me) obviously wrong or ill-designed, but keep the fix
  minimal
- stay quiet when idle and consume minimal memory
- ship with an uninstall button (so sad), so you can uninstall my **BLOAT** :)
  from your beloved system (I’d rather get an issue on the plugin page, though)
